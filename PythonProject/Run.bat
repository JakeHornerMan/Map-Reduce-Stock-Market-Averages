...
type ibmStock.txt | mapperAVG.py | sort | reducerAVG.py > output/IbmAvg_ReducerOutput.txt
...
type ibmStock.txt | mapperTvol.py | sort | reducerTvol.py > output/IbmTotalVolume_ReducerOutput.txt
